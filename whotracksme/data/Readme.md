...
This SQL database links third-party domains to trackers, which are then linked to unique companies operating those trackers. This is similar to [Disconnect's Tracker List](https://bit.ly/2ZylQRF) and [webXray's Domain Owner List](https://t.ly/EHuu). These parties are already categorized accordingly within the WhoTracks.me datasets below.
