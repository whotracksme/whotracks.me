...
def overview_bars(companies, highlight=2, height=None):
    ...
    fig.write_image('_site/static/images/company_bars.svg', height=450, width=740)
    with open('_site/static/images/company_bars.svg') as fp:
        ...
        <div class="plotly-graph-div js-plotly-plot" style="height: 100%; width: 100%;">
            <div class="plot-container plotly">
                <div class="svg-container" style="position: relative; width: 740px; height: 450px; margin: auto;">
                    {fp.read()}
                </div>
            </div>
        </div>
